...
$profile_image_blobview = NULL; // Initialize page object first

class cprofile_image_blobview extends cprofile {
	...
	// Page object name
	var $PageObjName = 'profile_image_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'profile');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('profile', 'x_image');
...
// Create page object
if (!isset($profile_image_blobview)) $profile_image_blobview = new cprofile_image_blobview();

// Page init
$profile_image_blobview->Page_Init();

// Page main
$profile_image_blobview->Page_Main();
?>
<?php
$profile_image_blobview->Page_Terminate();
?>
