...
class cforgotpwd extends cpelaku_kreatif {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["pelaku_kreatif"])) $GLOBALS["pelaku_kreatif"] = &$this;
...
<?php } ?>
	<div class="form-group">
		...
		<div class="col-sm-10"><input type="text" name="email" id="email" class="form-control ewControl" value="<?php ew_HtmlEncode($forgotpwd->Email) ?>" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($Language->Phrase("UserEmail")) ?>"></div>
	</div>
	<div class="form-group">
