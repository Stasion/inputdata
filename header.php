...
<link rel="stylesheet" type="text/css" href="<?php echo $EW_RELATIVE_PATH ?>bootstrap3/css/<?php echo ew_CssFile("bootstrap_custom.css") ?>">
<link rel="stylesheet" type="text/css" href="<?php echo $EW_RELATIVE_PATH ?>bootstrap3/css/<?php echo ew_CssFile("bootstrap-theme-custom.css") ?>">
<?php } ?>
<?php if (@$gsExport == "" || @$gsExport == "print") { ?>
...
<?php } ?>
<link href="phpcss/user_style.css" rel="stylesheet" type="text/css">
...
<div class="ewLayout">
    ...
    <div style="background-color:white">
        <div class="tengah">
            <div id="ewHeaderRow" class="<?php echo $gsHeaderRowClass ?>"><img src="<?php echo $EW_RELATIVE_PATH ?>phpimages/logo_pendataan.png" alt=""></div>
        </div>
    </div>
<?php if (ew_IsResponsiveLayout()) { ?>
