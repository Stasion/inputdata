...
// Page object
var produk_delete = new ew_Page("produk_delete");
produk_delete.PageID = "delete"; // Page ID
var EW_PAGE_ID = produk_delete.PageID; // For backward compatibility

// Form object
var fprodukdelete = new ew_Form("fprodukdelete");
...
fprodukdelete.Lists["x_id_pelaku_kreatif"] = {"LinkField":"x_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_nama_pemilik","x_nama_industri_kreatif","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
if ($produk_delete->Recordset = $produk_delete->LoadRecordset())
	$produk_deleteTotalRecs = $produk_delete->Recordset->RecordCount(); // Get record count
if ($produk_deleteTotalRecs <= 0) { // No record found, exit
	if ($produk_delete->Recordset)
		$produk_delete->Recordset->Close();
	$produk_delete->Page_Terminate("produklist.php"); // Return to list
}
?>
<div class="ewToolbar">
...
<?php if ($produk->nama_produk->Visible) { // nama_produk ?>
		<th><span id="elh_produk_nama_produk" class="produk_nama_produk"><?php echo $produk->nama_produk->FldCaption() ?></span></th>
<?php } ?>
<?php if ($produk->id_pelaku_kreatif->Visible) { // id_pelaku_kreatif ?>
		<th><span id="elh_produk_id_pelaku_kreatif" class="produk_id_pelaku_kreatif"><?php echo $produk->id_pelaku_kreatif->FldCaption() ?></span></th>
<?php } ?>
<?php if ($produk->harga->Visible) { // harga ?>
		<th><span id="elh_produk_harga" class="produk_harga"><?php echo $produk->harga->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<span id="el<?php echo $produk_delete->RowCnt ?>_produk_id" class="form-group produk_id">
...
<?php } ?>
<?php if ($produk->nama_produk->Visible) { // nama_produk ?>
		<td<?php echo $produk->nama_produk->CellAttributes() ?>>
<span id="el<?php echo $produk_delete->RowCnt ?>_produk_nama_produk" class="form-group produk_nama_produk">
<span<?php echo $produk->nama_produk->ViewAttributes() ?>>
<?php echo $produk->nama_produk->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($produk->id_pelaku_kreatif->Visible) { // id_pelaku_kreatif ?>
		<td<?php echo $produk->id_pelaku_kreatif->CellAttributes() ?>>
<span id="el<?php echo $produk_delete->RowCnt ?>_produk_id_pelaku_kreatif" class="form-group produk_id_pelaku_kreatif">
<span<?php echo $produk->id_pelaku_kreatif->ViewAttributes() ?>>
<?php echo $produk->id_pelaku_kreatif->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($produk->harga->Visible) { // harga ?>
		<td<?php echo $produk->harga->CellAttributes() ?>>
<span id="el<?php echo $produk_delete->RowCnt ?>_produk_harga" class="form-group produk_harga">
<span<?php echo $produk->harga->ViewAttributes() ?>>
<?php echo $produk->harga->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
