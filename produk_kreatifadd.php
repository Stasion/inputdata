...
$produk_kreatif_add = NULL; // Initialize page object first

class cproduk_kreatif_add extends cproduk_kreatif {
	...
	// Page object name
	var $PageObjName = 'produk_kreatif_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "produk_kreatifview.php")
	...
	function LoadDefaultValues() {
		...
		$this->id_pelaku_kreatif->CurrentValue = CurrentUserID();
...
// Create page object
if (!isset($produk_kreatif_add)) $produk_kreatif_add = new cproduk_kreatif_add();

// Page init
$produk_kreatif_add->Page_Init();

// Page main
$produk_kreatif_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$produk_kreatif_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var produk_kreatif_add = new ew_Page("produk_kreatif_add");
produk_kreatif_add.PageID = "add"; // Page ID
var EW_PAGE_ID = produk_kreatif_add.PageID; // For backward compatibility

// Form object
var fproduk_kreatifadd = new ew_Form("fproduk_kreatifadd");

// Validate form
fproduk_kreatifadd.Validate = function() {
...
fproduk_kreatifadd.Form_CustomValidate = 
...
fproduk_kreatifadd.ValidateRequired = true;
<?php } else { ?>
fproduk_kreatifadd.ValidateRequired = false; 
<?php } ?>
...
<?php $produk_kreatif_add->ShowPageHeader(); ?>
<?php
$produk_kreatif_add->ShowMessage();
?>
<form name="fproduk_kreatifadd" id="fproduk_kreatifadd" class="form-horizontal ewForm ewAddForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($produk_kreatif_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $produk_kreatif_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
fproduk_kreatifadd.Init();
</script>
<?php
$produk_kreatif_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$produk_kreatif_add->Page_Terminate();
?>
