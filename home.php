...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 'pelaku_kreatif'))
		$this->Page_Terminate("pelaku_kreatiflist.php"); // Exit and go to default page
		if ($Security->AllowList(CurrentProjectID() . 'produk'))
			$this->Page_Terminate("produklist.php");
		if ($Security->AllowList(CurrentProjectID() . 'sektor'))
			$this->Page_Terminate("sektorlist.php");
		if ($Security->AllowList(CurrentProjectID() . 'profile'))
			$this->Page_Terminate("profilelist.php");
		if ($Security->AllowList(CurrentProjectID() . 'produk_kreatif'))
			$this->Page_Terminate("produk_kreatiflist.php");
