...
define("EW_PROJECT_NAME", "mcf", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{D322CAA1-B5DF-4315-A18C-262A6180EE7B}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'Ac5Em5549CbYddg7', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/mcf.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_USER", 'mcfdb', TRUE);
define("EW_CONN_PASS", 'c1L8bqCU5cXP', TRUE);
define("EW_CONN_DB", 'mcfdb', TRUE);
...
$EW_LANGUAGE_FILE[] = array("id", "", "indonesian.xml");
define("EW_LANGUAGE_DEFAULT_ID", "id", TRUE);
...
// Security
define("EW_ADMIN_USER_NAME", "algo", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "algostudiorocks123!", TRUE); // Administrator password
...
// User table filters
define("EW_USER_TABLE", "`pelaku_kreatif`",  TRUE);
define("EW_USER_NAME_FILTER", "(`email` = '%u')",  TRUE);
define("EW_USER_ID_FILTER", "(`id` = %u)",  TRUE);
...
// Email
define("EW_SMTP_SERVER", "mail.malangcreativefusion.com", TRUE); // SMTP server
define("EW_SMTP_SERVER_PORT", 25, TRUE); // SMTP server port
define("EW_SMTP_SECURE_OPTION", "", TRUE);
define("EW_SMTP_SERVER_USERNAME", "info@malangcreativefusion.com", TRUE); // SMTP server user name
define("EW_SMTP_SERVER_PASSWORD", "mcf20161qaz", TRUE); // SMTP server password
define("EW_SENDER_EMAIL", "info@malangcreativefusion.com", TRUE); // Sender email address
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "gif,jpg,jpeg,bmp,png", TRUE); // Allowed file extensions
