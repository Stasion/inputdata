...
class cchangepwd extends cpelaku_kreatif {
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 'pelaku_kreatif');
	...
	function Page_Main() {
		...
		if ($bPwdUpdated) {
			...
			$this->Page_Terminate("home.php"); // Exit page and clean up
		}
	}
