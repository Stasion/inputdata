...
//
// Table class for profile
//
class cprofile extends cTable {
	var $id;
	var $nama_pemilik;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('profile', 'profile', 'x_id', 'id', 'pelaku_kreatif.id', 'pelaku_kreatif.id', 3, -1, FALSE, 'pelaku_kreatif.id', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// nama_pemilik
		$this->nama_pemilik = new cField('profile', 'profile', 'x_nama_pemilik', 'nama_pemilik', 'pelaku_kreatif.nama_pemilik', 'pelaku_kreatif.nama_pemilik', 200, -1, FALSE, 'pelaku_kreatif.nama_pemilik', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nama_pemilik'] = &$this->nama_pemilik;

		// nama_industri_kreatif
		$this->nama_industri_kreatif = new cField('profile', 'profile', 'x_nama_industri_kreatif', 'nama_industri_kreatif', 'pelaku_kreatif.nama_industri_kreatif', 'pelaku_kreatif.nama_industri_kreatif', 200, -1, FALSE, 'pelaku_kreatif.nama_industri_kreatif', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['nama_industri_kreatif'] = &$this->nama_industri_kreatif;

		// email
		$this->_email = new cField('profile', 'profile', 'x__email', 'email', 'pelaku_kreatif.email', 'pelaku_kreatif.email', 200, -1, FALSE, 'pelaku_kreatif.email', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['email'] = &$this->_email;

		// password
		$this->password = new cField('profile', 'profile', 'x_password', 'password', 'pelaku_kreatif.password', 'pelaku_kreatif.password', 200, -1, FALSE, 'pelaku_kreatif.password', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['password'] = &$this->password;

		// deskripsi_industri_kreatif
		$this->deskripsi_industri_kreatif = new cField('profile', 'profile', 'x_deskripsi_industri_kreatif', 'deskripsi_industri_kreatif', 'pelaku_kreatif.deskripsi_industri_kreatif', 'pelaku_kreatif.deskripsi_industri_kreatif', 201, -1, FALSE, 'pelaku_kreatif.deskripsi_industri_kreatif', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['deskripsi_industri_kreatif'] = &$this->deskripsi_industri_kreatif;

		// alamat
		$this->alamat = new cField('profile', 'profile', 'x_alamat', 'alamat', 'pelaku_kreatif.alamat', 'pelaku_kreatif.alamat', 201, -1, FALSE, 'pelaku_kreatif.alamat', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['alamat'] = &$this->alamat;

		// image
		$this->image = new cField('profile', 'profile', 'x_image', 'image', 'pelaku_kreatif.image', 'pelaku_kreatif.image', 200, -1, TRUE, 'pelaku_kreatif.image', FALSE, FALSE, FALSE, 'IMAGE');
		$this->fields['image'] = &$this->image;

		// website
		$this->website = new cField('profile', 'profile', 'x_website', 'website', 'pelaku_kreatif.website', 'pelaku_kreatif.website', 200, -1, FALSE, 'pelaku_kreatif.website', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['website'] = &$this->website;

		// sektor_industri_kreatif
		$this->sektor_industri_kreatif = new cField('profile', 'profile', 'x_sektor_industri_kreatif', 'sektor_industri_kreatif', 'pelaku_kreatif.sektor_industri_kreatif', 'pelaku_kreatif.sektor_industri_kreatif', 3, -1, FALSE, 'pelaku_kreatif.sektor_industri_kreatif', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		...
		// no_telp
		$this->no_telp = new cField('profile', 'profile', 'x_no_telp', 'no_telp', 'pelaku_kreatif.no_telp', 'pelaku_kreatif.no_telp', 200, -1, FALSE, 'pelaku_kreatif.no_telp', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function getSqlSelect() { // Select
		return ($this->_SqlSelect <> "") ? $this->_SqlSelect : "SELECT pelaku_kreatif.id, pelaku_kreatif.nama_pemilik, pelaku_kreatif.nama_industri_kreatif, pelaku_kreatif.email, pelaku_kreatif.password, pelaku_kreatif.deskripsi_industri_kreatif, pelaku_kreatif.alamat, pelaku_kreatif.image, pelaku_kreatif.website, pelaku_kreatif.sektor_industri_kreatif, pelaku_kreatif.no_telp FROM " . $this->getSqlFrom();
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("profileview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("profileview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			return "profileadd.php?" . $this->UrlParm($parm);
		else
			return "profileadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("profileedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("profileadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("profiledelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function AddUserIDFilter($sFilter) {
		...
		if (!$this->UserIDAllow($id) && !$Security->IsAdmin()) {
			...
			if ($sFilterWrk <> "")
				$sFilterWrk = 'pelaku_kreatif.id IN (' . $sFilterWrk . ')';
		}
