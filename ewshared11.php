...
function Menu_Rendering(&$Menu) {
	...
	if ($Menu->IsRoot) { // Root menu
		 $Menu->AddMenuItem(10000, "EditProfil", "Edit Profil", "profileedit.php?id=".CurrentUserID(), -1, "", IsLoggedIn());
	     $Menu->MoveItem("Logout", $Menu->Count() - 1); 
	 } 

//	$Menu->AddMenuItem(10001, "edit profile", "edit profil", , 178, "", IsLoggedIn());
}
