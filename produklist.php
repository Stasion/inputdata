...
class cproduk_list extends cproduk {
	...
	function AdvancedSearchWhere($Default = FALSE) {
		...
		$this->BuildSearchSql($sWhere, $this->nama_produk, $Default, FALSE); // nama_produk
		$this->BuildSearchSql($sWhere, $this->deskripsi, $Default, FALSE); // deskripsi
		$this->BuildSearchSql($sWhere, $this->id_pelaku_kreatif, $Default, FALSE); // id_pelaku_kreatif
		$this->BuildSearchSql($sWhere, $this->harga, $Default, FALSE); // harga
		$this->BuildSearchSql($sWhere, $this->foto_produk, $Default, FALSE); // foto_produk
		...
		if (!$Default && $this->Command == "search") {
			...
			$this->nama_produk->AdvancedSearch->Save(); // nama_produk
			$this->deskripsi->AdvancedSearch->Save(); // deskripsi
			$this->id_pelaku_kreatif->AdvancedSearch->Save(); // id_pelaku_kreatif
			$this->harga->AdvancedSearch->Save(); // harga
			$this->foto_produk->AdvancedSearch->Save(); // foto_produk
		}
		return $sWhere;
	}
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->foto_produk, $arKeywords, $type);
		return $sWhere;
	}
	...
	function CheckSearchParms() {
		...
		if ($this->id->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->nama_produk->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->deskripsi->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->id_pelaku_kreatif->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->harga->AdvancedSearch->IssetSession())
			return TRUE;
		if ($this->foto_produk->AdvancedSearch->IssetSession())
			return TRUE;
		return FALSE;
	}
	...
	function ResetAdvancedSearchParms() {
		...
		$this->nama_produk->AdvancedSearch->UnsetSession();
		$this->deskripsi->AdvancedSearch->UnsetSession();
		$this->id_pelaku_kreatif->AdvancedSearch->UnsetSession();
		$this->harga->AdvancedSearch->UnsetSession();
		$this->foto_produk->AdvancedSearch->UnsetSession();
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->id_pelaku_kreatif); // id_pelaku_kreatif
	...
	function ResetCmd() {
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->id_pelaku_kreatif->setSort("");
				$this->harga->setSort("");
			}
	...
	function RenderOtherOptions() {
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->CustomActions as $action => $name) {
				...
				$item->Body = "<a class=\"ewAction ewCustomAction\" href=\"\" onclick=\"ew_SubmitSelected(document.fproduklist, '" . ew_CurrentUrl() . "', null, '" . $action . "');return false;\">" . $name . "</a>";
			}
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<a class=\"btn btn-default ewAdvancedSearch\" title=\"" . $Language->Phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->Phrase("AdvancedSearch") . "\" href=\"produksrch.php\">" . $Language->Phrase("AdvancedSearchBtn") . "</a>";
		$item->Visible = TRUE;
	...
	function LoadSearchValues() {
		...
		// nama_produk
		$this->nama_produk->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_nama_produk"]);
		if ($this->nama_produk->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->nama_produk->AdvancedSearch->SearchOperator = @$_GET["z_nama_produk"];
		...
		// id_pelaku_kreatif
		$this->id_pelaku_kreatif->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_id_pelaku_kreatif"]);
		if ($this->id_pelaku_kreatif->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->id_pelaku_kreatif->AdvancedSearch->SearchOperator = @$_GET["z_id_pelaku_kreatif"];
		...
		// foto_produk
		$this->foto_produk->AdvancedSearch->SearchValue = ew_StripSlashes(@$_GET["x_foto_produk"]);
		if ($this->foto_produk->AdvancedSearch->SearchValue <> "") $this->Command = "search";
		$this->foto_produk->AdvancedSearch->SearchOperator = @$_GET["z_foto_produk"];
	}
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_produk\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_produk',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fproduklist,sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = FALSE;
...
<?php if ($produk->Export == "") { ?>
<script type="text/javascript">

// Page object
var produk_list = new ew_Page("produk_list");
produk_list.PageID = "list"; // Page ID
var EW_PAGE_ID = produk_list.PageID; // For backward compatibility

// Form object
var fproduklist = new ew_Form("fproduklist");
...
fproduklist.Lists["x_id_pelaku_kreatif"] = {"LinkField":"x_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_nama_pemilik","x_nama_industri_kreatif","",""],"ParentFields":[],"FilterFields":[],"Options":[]};

// Form object for search
var fproduklistsrch = new ew_Form("fproduklistsrch");
</script>
<script type="text/javascript">
...
<?php
	...
	if ($produk->CurrentAction == "" && $produk_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$produk_list->setWarningMessage($Language->Phrase("NoPermission"));
...
<?php if ($produk_list->TotalRecs > 0) { ?>
...
<?php if ($produk->nama_produk->Visible) { // nama_produk ?>
	<?php if ($produk->SortUrl($produk->nama_produk) == "") { ?>
		<th data-name="nama_produk"><div id="elh_produk_nama_produk" class="produk_nama_produk"><div class="ewTableHeaderCaption"><?php echo $produk->nama_produk->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="nama_produk"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $produk->SortUrl($produk->nama_produk) ?>',1);"><div id="elh_produk_nama_produk" class="produk_nama_produk">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $produk->nama_produk->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($produk->nama_produk->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($produk->nama_produk->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($produk->id_pelaku_kreatif->Visible) { // id_pelaku_kreatif ?>
	<?php if ($produk->SortUrl($produk->id_pelaku_kreatif) == "") { ?>
		<th data-name="id_pelaku_kreatif"><div id="elh_produk_id_pelaku_kreatif" class="produk_id_pelaku_kreatif"><div class="ewTableHeaderCaption"><?php echo $produk->id_pelaku_kreatif->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id_pelaku_kreatif"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $produk->SortUrl($produk->id_pelaku_kreatif) ?>',1);"><div id="elh_produk_id_pelaku_kreatif" class="produk_id_pelaku_kreatif">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $produk->id_pelaku_kreatif->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($produk->id_pelaku_kreatif->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($produk->id_pelaku_kreatif->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($produk->harga->Visible) { // harga ?>
	<?php if ($produk->SortUrl($produk->harga) == "") { ?>
		<th data-name="harga"><div id="elh_produk_harga" class="produk_harga"><div class="ewTableHeaderCaption"><?php echo $produk->harga->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="harga"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $produk->SortUrl($produk->harga) ?>',1);"><div id="elh_produk_harga" class="produk_harga">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $produk->harga->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($produk->harga->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($produk->harga->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<a id="<?php echo $produk_list->PageObjName . "_row_" . $produk_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($produk->nama_produk->Visible) { // nama_produk ?>
		<td data-name="nama_produk"<?php echo $produk->nama_produk->CellAttributes() ?>>
<span<?php echo $produk->nama_produk->ViewAttributes() ?>>
<?php echo $produk->nama_produk->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($produk->id_pelaku_kreatif->Visible) { // id_pelaku_kreatif ?>
		<td data-name="id_pelaku_kreatif"<?php echo $produk->id_pelaku_kreatif->CellAttributes() ?>>
<span<?php echo $produk->id_pelaku_kreatif->ViewAttributes() ?>>
<?php echo $produk->id_pelaku_kreatif->ListViewValue() ?></span>
</td>
	<?php } ?>
	<?php if ($produk->harga->Visible) { // harga ?>
		<td data-name="harga"<?php echo $produk->harga->CellAttributes() ?>>
...
<?php if ($produk_list->Pager->RecordCount > 0) { ?>
<div class="ewPager">
