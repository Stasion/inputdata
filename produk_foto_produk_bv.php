...
$produk_foto_produk_blobview = NULL; // Initialize page object first

class cproduk_foto_produk_blobview extends cproduk {
	...
	// Page object name
	var $PageObjName = 'produk_foto_produk_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'produk');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('produk', 'x_foto_produk');
...
// Create page object
if (!isset($produk_foto_produk_blobview)) $produk_foto_produk_blobview = new cproduk_foto_produk_blobview();

// Page init
$produk_foto_produk_blobview->Page_Init();

// Page main
$produk_foto_produk_blobview->Page_Main();
?>
<?php
$produk_foto_produk_blobview->Page_Terminate();
?>
