...
$produk_kreatif_view = NULL; // Initialize page object first

class cproduk_kreatif_view extends cproduk_kreatif {
	...
	// Page object name
	var $PageObjName = 'produk_kreatif_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "produk_kreatiflist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "produk_kreatiflist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "produk_kreatiflist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($produk_kreatif_view)) $produk_kreatif_view = new cproduk_kreatif_view();

// Page init
$produk_kreatif_view->Page_Init();

// Page main
$produk_kreatif_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$produk_kreatif_view->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var produk_kreatif_view = new ew_Page("produk_kreatif_view");
produk_kreatif_view.PageID = "view"; // Page ID
var EW_PAGE_ID = produk_kreatif_view.PageID; // For backward compatibility

// Form object
var fproduk_kreatifview = new ew_Form("fproduk_kreatifview");

// Form_CustomValidate event
fproduk_kreatifview.Form_CustomValidate = 
...
fproduk_kreatifview.ValidateRequired = true;
<?php } else { ?>
fproduk_kreatifview.ValidateRequired = false; 
<?php } ?>
...
<?php $produk_kreatif_view->ExportOptions->Render("body") ?>
<?php
	foreach ($produk_kreatif_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php echo $Language->SelectionForm(); ?>
<div class="clearfix"></div>
</div>
<?php $produk_kreatif_view->ShowPageHeader(); ?>
<?php
$produk_kreatif_view->ShowMessage();
?>
<form name="fproduk_kreatifview" id="fproduk_kreatifview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($produk_kreatif_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $produk_kreatif_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="produk_kreatif">
<table class="table table-bordered table-striped ewViewTable">
<?php if ($produk_kreatif->nama_produk->Visible) { // nama_produk ?>
	<tr id="r_nama_produk">
		<td><span id="elh_produk_kreatif_nama_produk"><?php echo $produk_kreatif->nama_produk->FldCaption() ?></span></td>
		<td<?php echo $produk_kreatif->nama_produk->CellAttributes() ?>>
<span id="el_produk_kreatif_nama_produk" class="form-group">
<span<?php echo $produk_kreatif->nama_produk->ViewAttributes() ?>>
<?php echo $produk_kreatif->nama_produk->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($produk_kreatif->deskripsi->Visible) { // deskripsi ?>
	<tr id="r_deskripsi">
		<td><span id="elh_produk_kreatif_deskripsi"><?php echo $produk_kreatif->deskripsi->FldCaption() ?></span></td>
		<td<?php echo $produk_kreatif->deskripsi->CellAttributes() ?>>
<span id="el_produk_kreatif_deskripsi" class="form-group">
<span<?php echo $produk_kreatif->deskripsi->ViewAttributes() ?>>
<?php echo $produk_kreatif->deskripsi->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($produk_kreatif->harga->Visible) { // harga ?>
	<tr id="r_harga">
		<td><span id="elh_produk_kreatif_harga"><?php echo $produk_kreatif->harga->FldCaption() ?></span></td>
		<td<?php echo $produk_kreatif->harga->CellAttributes() ?>>
<span id="el_produk_kreatif_harga" class="form-group">
<span<?php echo $produk_kreatif->harga->ViewAttributes() ?>>
<?php echo $produk_kreatif->harga->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($produk_kreatif->foto_produk->Visible) { // foto_produk ?>
	<tr id="r_foto_produk">
		<td><span id="elh_produk_kreatif_foto_produk"><?php echo $produk_kreatif->foto_produk->FldCaption() ?></span></td>
		<td<?php echo $produk_kreatif->foto_produk->CellAttributes() ?>>
<span id="el_produk_kreatif_foto_produk" class="form-group">
<span>
<?php echo ew_GetFileViewTag($produk_kreatif->foto_produk, $produk_kreatif->foto_produk->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<script type="text/javascript">
fproduk_kreatifview.Init();
</script>
<?php
$produk_kreatif_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$produk_kreatif_view->Page_Terminate();
?>
